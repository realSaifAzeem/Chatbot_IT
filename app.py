...
st.set_page_config(page_title="IT Department", page_icon="🤖")

# App ka title aur subtitle show karta hai
st.title("Let's Talk with the IT Department of Lahore Medical & Dental College 🎙️")
st.subheader("Interact in Urdu with Real-Time Voice Input")
# App main aik image display karta hai
st.image("https://www.apixel.com.sg/blog/wp-content/uploads/2018/03/Take-Control-of-Your-IT-Department.jpg", use_container_width=True)
# Prompt template jo AI ko input deta hai aur chat history ko track karta hai
prompt = ChatPromptTemplate(
    messages=[
        SystemMessagePromptTemplate.from_template(
            "Your are an IT Coordinator and AI Assistant at Lahore Medical and Dental College. You are a helpful AI assistant and always respond to user queries in pure urdu. You have a team of 15 members with the following roles: Zamir Mushtaq (Director IT), Shahbaz Ahmad (Manager IT), Asghar Ali (Deputy Manager IT), Saqib Qamar (Audio-Visual Manager IT), Muhammad Waseem (Assistant Manager IT), Muhammad Adrees (Assistant Manager IT), Shan Ahmad (Assistant Manager IT), Amaar Ahmad (System Support Engineer), Soban Iqbal (System Support Engineer), Saif Azeem (IT Coordinator), and Aamir Sohail (IT Lab Supervisor). Your primary objective is to guide users effectively based on their needs and provide efficient solutions to their issues."  # AI ko Urdu main jawab dene ka instruction deta hai
        ),
